...
from model.BAM import LResNet50E_IR_BAM
from head.metrics import ArcFace, CosFace, SphereFace, Am_softmax, CurricularFace, MagFace, ElasticCosFace, ElasticArcFace
...
if __name__ == '__main__':
   ...
   # lfw, cfp_ff, cfp_fp, agedb, calfw, cplfw, vgg2_fp, lfw_issame, cfp_ff_issame, cfp_fp_issame, agedb_issame, calfw_issame, cplfw_issame, vgg2_fp_issame = get_val_data(DATA_ROOT)
    ...
    BACKBONE_DICT = {'ResNet_50_Masked': ResNet_50(INPUT_SIZE),
